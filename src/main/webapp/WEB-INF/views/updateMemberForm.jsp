...
<html>
    ...
    <body>
        ...
        <form action="/member/edit" method="POST">
            <div class="input-box">
                <input id="email" type="email" name="email" placeholder="이메일" value="${email}">
                <label for="email"> 이메일</label>
            </div>

            <div class="input-box">
                <input id="nickname" type="text" name="nickname" placeholder="닉네임" value="${nickname}">
                <label for="nickname">닉네임</label>
            </div>

            <div class="input-box">
                <input id="phoneNumber" type="text" name="phoneNumber" placeholder="핸드폰번호" value="${phoneNumber}">
            ...
            <div class="input-box">
                <input id="password" type="password" name="password" placeholder="비밀번호" value="${password}">
